  ...
  <el-container class="shell">
    ...
    <el-container>
      <el-header>
        ...
        <div class="top">
          <el-tag type="success">Demo 数据</el-tag>
...
const menus = [{path: '/dashboard', name: '运营总览', icon: DataAnalysis}, {
  path: '/users',
  name: '用户与积分',
  icon: User
}, {path: '/jobs', name: 'AI 任务中心', icon: VideoPlay}, {
  path: '/contents',
  name: '内容审核',
  icon: DocumentChecked
}, {path: '/orders', name: '订单与套餐', icon: ShoppingBag}, {path: '/system', name: '系统运营', icon: Setting}];
